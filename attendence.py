...
class VideoStream:
    ...
    def stop(self):
        ...
        #here is the main stuff for face recognition
    def encode_faces():
        encoded_data = {}
        ...
        return encoded_data
          ...
          #this will take care of record and saving everything in csv file
...
# 0 refers to default webcam your device have , and didnt added other functionality
# as it will make conflicts with main io device and hence more complex the rendering
    ...
    while True:
        if video_stream.stopped is True:
            ...
            #it will call function attendence
                Attendance(name)
# this will create some lag so u can buy some time for rendering the thing
        delay = 0.04
        time.sleep(delay)
